...
The installed plugin normally starts the published `deepseek-harness-mcp@0.2.1` package. During local MCP development, temporarily point the plugin's `.mcp.json` at the absolute `dist/bin.mjs` path.
